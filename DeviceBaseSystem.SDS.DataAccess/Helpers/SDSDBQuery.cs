using Anatoli.SDS.ViewModels.BaseModels;
using System;
...
{
    public  class SDSDBQuery
    {
        private static List<SDSDBQueryViewModel> queryList = new List<SDSDBQueryViewModel>();
        private static  SDSDBQuery instance = null;
        public static SDSDBQuery Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new SDSDBQuery();
                    using (var context = new DataContext())
                    {
                        var data = context.All<SDSDBQueryViewModel>(@"select UniqueId, QueryName, QueryTSQL from AnatoliQuery");
